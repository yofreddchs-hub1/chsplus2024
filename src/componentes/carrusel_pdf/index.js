        ...
        <Grid container spacing={2}>
            <Grid item xs={12}>
                <Box sx={{
                    ...
                    onClick={()=>console.log('Paoaooa')}
                >
                    
                  <embed onClick={()=>console.log('Paoaooa')} src={`${process.env.PUBLIC_URL +'/utilidad/catalogos/CHS+ CATALOGO 2022.pdf'}#toolbar=0&navpanes=0&scrollbar=0&pagemode=none`} type="application/pdf" width="100%" height="100%" />
